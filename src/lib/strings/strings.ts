...
export const aboutUsText = "Our company was founded by experienced clinicians and software engineers."+
 " We were brought together with the goal of helping make the job of busy clincians easier through technology " +
 " while making sure that client confidentialty and well being are front and center." 
